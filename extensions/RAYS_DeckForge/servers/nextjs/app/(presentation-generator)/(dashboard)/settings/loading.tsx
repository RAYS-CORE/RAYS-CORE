    ...
    return (
        <div className="h-screen font-syne flex flex-col overflow-hidden relative">
            ...
            <main className="w-full mx-auto gap-6 overflow-hidden flex">
                ...
                <div className="w-full max-w-[230px] h-screen px-4 pt-[22px] bg-sidebar flex flex-col shrink-0">
                    <div className="mt-[3.15rem] border-b border-sidebar-border pb-3.5">
                    ...
                    <div className="border-t border-sidebar-border py-5">
