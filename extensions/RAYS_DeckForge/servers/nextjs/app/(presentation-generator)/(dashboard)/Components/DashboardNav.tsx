            ...
            <div className="flex xl:flex-row flex-col gap-6 xl:gap-0 items-center justify-between">
                ...
                <div className="flex  gap-2.5 max-sm:w-full max-md:justify-center max-sm:flex-wrap">
                    ...
                    {activeTab !== "playground" && activeTab !== "theme" && <Link
                        href="/generate"
                        className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-foreground text-sm font-medium shadow-sm hover:shadow-md"
                    ...
                    {activeTab === "theme" &&
                        <Link
                            ...
                            className="inline-flex items-center font-inter font-normal gap-2 rounded-xl px-4 py-2.5 text-foreground text-sm  shadow-sm hover:shadow-md"
