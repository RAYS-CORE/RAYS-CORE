                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            disabled={!hasChanges}
                            size="sm"
                            className="h-7 px-3 text-[11px] bg-emerald-500 hover:bg-emerald-600 text-foreground disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex items-center gap-2 min-w-0">
                                                    ...
                                                    <span className={`text-sm font-medium truncate ${isChild ? 'text-foreground' : 'text-foreground'}`}>
                                                ...
                                                <ChevronRight className={`w-3.5 h-3.5 text-muted-foreground flex-shrink-0 transition-transform ${fExpanded ? 'rotate-90' : ''}`} />
                                            </button>

                                            {fExpanded && (
                                                <div className="px-2.5 pb-2.5 pt-1.5 border-t border-border">
                                                    {f.description && (
                                                    ...
                                                    {f.type === 'string' && (
                                                        <div className="grid grid-cols-2 gap-2">
                                                            <div>
                                                                <Label className="text-xs text-foreground mb-1 block">Min chars</Label>
                                                                <Input
                                                                    type="number"
                                                                    min={0}
                                                                    value={f.minLength ?? ''}
                                                            ...
                                                            <div>
                                                                <Label className="text-xs text-foreground mb-1 block">Max chars</Label>
                                                                <Input
                                                                    type="number"
                                                                    min={0}
                                                                    value={f.maxLength ?? ''}
                                                    ...
                                                    {f.type === 'array' && (
                                                        <div className="grid grid-cols-2 gap-2">
                                                            <div>
                                                                <Label className="text-xs text-foreground mb-1 block">Min items</Label>
                                                                <Input
                                                                    type="number"
                                                                    min={0}
                                                                    value={f.minItems ?? ''}
                                                            ...
                                                            <div>
                                                                <Label className="text-xs text-foreground mb-1 block">Max items</Label>
                                                                <Input
                                                                    type="number"
                                                                    min={0}
                                                                    value={f.maxItems ?? ''}
                                                    ...
                                                    {f.default !== undefined && typeof f.default !== 'object' && (
                                                        <div className="mt-3">
                                                            <Label className="text-xs text-foreground mb-1 block">Current value</Label>
