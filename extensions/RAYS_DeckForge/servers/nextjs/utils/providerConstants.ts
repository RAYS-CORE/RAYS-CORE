...
export const IMAGE_PROVIDERS: Record<string, ImageProviderOption> = {
  pexels: {
    ...
    getApiKeyUrl: "https://docs.rays.deckforge.local/help/get-api-keys/get-pexels-api-key",
  },
  pixabay: {
    value: "pixabay",
    label: "Pixabay",
    ...
    getApiKeyUrl: "https://docs.rays.deckforge.local/help/get-api-keys/get-pixabay-api-keyhttps://www.google.com/search?q=how+to+get+openai+api+key&ie=UTF-8",
  },
  "dall-e-3": {
    value: "dall-e-3",
    label: "DALL-E 3",
