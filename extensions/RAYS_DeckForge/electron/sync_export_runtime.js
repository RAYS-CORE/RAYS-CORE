...
const exportRepoBase = "https://github.com/rays/deckforge-export/releases/download";
...
async function getTargetVersion() {
  ...
  const apiUrl = "https://api.github.com/repos/rays/deckforge-export/releases/latest";
...
function requestJson(url, redirects = 5) {
  return new Promise((resolve, reject) => {
    ...
    const req = client.get(
      ...
      {
        headers: {
          "User-Agent": "deckforge-export-runtime-sync",
