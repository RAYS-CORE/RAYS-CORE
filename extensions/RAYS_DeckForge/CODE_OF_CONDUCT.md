# RAYS DeckForge Code of Conduct

## Our Community

The **RAYS DeckForge** community is made up of contributors, developers, designers, researchers, and users from all around the world. Together we are building an open-source platform for **AI-powered presentation generation**.
...
📧 **Email:** [suraj@rays.deckforge.local](mailto:suraj@rays.deckforge.local)
