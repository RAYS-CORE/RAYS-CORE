...
```bash
python3 -m pyfiglet "RAYS_CORE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=RAYS_CORE&font=Slant" | boxes -d stone
```
