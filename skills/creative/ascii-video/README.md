...
Built for [RAYS-CORE](https://github.com/NousResearch/rays-core). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/rays-core/skills/creative/ascii-video`](https://github.com/NousResearch/rays-core/tree/main/skills/creative/ascii-video) via PR.
